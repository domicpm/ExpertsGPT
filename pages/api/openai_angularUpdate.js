...
const pdfFile = "C:\\Users\\domin\\Dropbox\\BachelorArbeit\\AngularUpdate\\v10_to_v17.pdf";
...
const myExportedFunction = async (req, res) => {
 ...
 userText = `Du bist Experte für Angular Update. Gebe mir Informationen basierend auf dem Dokument  ${req.body.name}`;
